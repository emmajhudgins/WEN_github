...
#[9] tidyverse_1.3.1 remotes_2.4.2  

#loaded via a namespace (and not attached):
#[1] Rcpp_1.0.8       cellranger_1.1.0 pillar_1.7.0     compiler_4.0.3  
#[5] dbplyr_2.1.1     tools_4.0.3      jsonlite_1.7.3   lubridate_1.8.0 
#[9] lifecycle_1.0.1  gtable_0.3.0     pkgconfig_2.0.3  rlang_1.0.1     
#[13] reprex_2.0.1     rstudioapi_0.13  DBI_1.1.2        cli_3.2.0       
#[17] haven_2.4.3      xml2_1.3.3       withr_2.4.3      httr_1.4.2      
#[21] fs_1.5.2         generics_0.1.2   vctrs_0.3.8      hms_1.1.1       
#[25] grid_4.0.3       tidyselect_1.1.1 glue_1.6.1       R6_2.5.1        
...
#[41] stringi_1.7.6    munsell_0.5.0    broom_0.7.12     crayon_1.5.0  
...
write.csv(penguins_raw, "Raw data/penguins_raw.csv",
          row.names = FALSE)
...
# [row, column] and we want columns 3:6 and 8 which are the numeric ones
...
# "?" and your function will give you information e.g., "?boxplot"
